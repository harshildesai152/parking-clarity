...
parkingSchema.index({ category: 1 });
parkingSchema.index({ parkingType: 1 });
parkingSchema.index({ 'capacity.car.available': 1 });
parkingSchema.index({ 'capacity.motorcycle.available': 1 });
parkingSchema.index({ 'capacity.truck.available': 1 });
